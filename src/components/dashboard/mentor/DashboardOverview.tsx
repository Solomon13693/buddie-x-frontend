...
const statsConfig: Record<keyof DashboardData, StatConfig> = {
    ...
    total_reviews: { label: 'Total Reviews', icon: StarIcon },
    average_rating: { label: 'Average Rating', icon: StarIcon },
    attendance_rate: { label: 'Attendance Rate', icon: ChartBarIcon },
};

const DashboardOverview = () => {

    const { response, isLoading } = useGetStats();
