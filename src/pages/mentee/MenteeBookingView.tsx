...
const MenteeBookingView: React.FC = () => {
    ...
    const { response, isLoading } = useGetMenteeBookings(params)
                    ...
                    <div className="grid gap-3">
                        ...
                        {isLoading ? (
                            ...
                            data.map((session: BookingType) => (
                                <BookingCard role="mentee" item={session} key={session.id} />
                            ))
                        ) : (
                            <>
...
export default MenteeBookingView;
