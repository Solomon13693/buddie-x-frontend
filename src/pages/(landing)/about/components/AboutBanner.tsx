...
const AboutBanner = () => {
    return (
        <GradientHeroBanner
            ...
            stats="23,500+ tools. 1,000+ startups. Hundreds of communities, jobs, newsletters, ideas. All in one place."
            chip={(
            ...
            cardSubtitle="Career Guidance | Portfolio Reviews | Interview Preparation | Skill Development | Project Mentorship | Job Search Strategy"
            cardTitle="Mentorship without borders"
            cardDescription="Buddie-X was created to make expert mentorship more accessible, whether you are building your career, growing a business, developing new skills, or looking for clarity on your next move. From Lagos to London, Mumbai to New York, we help people connect with mentors and peers who can offer practical insight, real experience, and direction."
