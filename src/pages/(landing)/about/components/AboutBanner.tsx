                ...
                <div className="rounded-[10px] bg-white p-5 shadow-[0px_4px_114px_0px_#00000017] px-8 lg:px-14">
                    ...
                    <div className="grid items-center gap-x-8 gap-y-10 md:grid-cols-2">
                        ...
                        <div className="w-full max-w-md space-y-2">
                            ...
                            <h2 className="text-xl font-medium tracking-tight text-[#111827]">Mentorship without borders</h2>

                            <p className="text-xs text-[#29282B] pb-2">Buddie-X was created to make expert mentorship more accessible, whether you are building your career, growing a business, developing new skills, or looking for clarity on your next move.
From Lagos to London, Mumbai to New York, we help people connect with mentors and peers who can offer practical insight, real experience, and direction.</p>
